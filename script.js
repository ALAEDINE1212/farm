...
const overviewMap = {
  ...
  olives:    [["عدد","count"],["مصاريف","medCosts"],["تاريخ قطاف","harvestDate"]],
  cowFemales:[["رقم","id"],["مصاريف","expenses"],["ثمن بيع","sellPrice"]],
  cowMales:  [["رقم","id"],["مصاريف","expenses"],["ثمن بيع","sellPrice"]]
};

let selectedFarm=null, currentList=null, currentKey=null;
...
window.addEventListener("DOMContentLoaded",()=>{
  ...
  function openModal(sec,key,data){
    ...
    save.addEventListener("click",e=>{
      e.preventDefault();
      const updates={};
      Array.from(modalForm.elements).filter(el=>el.name)
